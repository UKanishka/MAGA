                ...
                <div class="navbar-header">
                    <a href="index-2.html" class="navbar-brand">
                        ...
                        <div class="brand-title">
                            <span class="brand-text">MAGA CMMS</span>
                        </div>
                    </a>
                </div>
                <!--================================-->
                                    ...
                                    <div class="nano-content">
                                        <ul class="head-list">
                                            ...
                                            <li>
                                                <a class="media" href="#">
                                                    <div class="media-left">
                                                        <img class="img-circle img-sm" alt="Profile Picture" src="../../assets/img/profile-photos/3.png">
                                                    </div>
                                                    <div class="media-body">
                            ...
                            <div class="nano-content">
                                ...
                                <div id="mainnav-profile" class="mainnav-profile">
                                    <div class="profile-wrap text-center">
                                        ...
                                        <a href="#profile-nav" class="box-block" data-toggle="collapse" aria-expanded="false">
                                            ...
                                            <p class="mnp-name">Kanishka</p>
                                            <span class="mnp-desc">kanishka@mail.com</span>
                                        </a>
                                    </div>
                                ...
                                <ul id="mainnav-menu" class="list-group">
                                    ...
                                    <li>
                                        ...
                                        <!--Submenu-->
                                        <ul class="collapse">
                                            <li><a href='<?php echo site_url("equipment/index"); ?>'>Equipment</a></li>
                                            <li><a href='<?php echo site_url("supplier/index"); ?>'>Supplier</a></li>
                                            <li><a href='<?php echo site_url("user/manage"); ?>'>User</a></li>
                                        </ul>
                                    </li>
